...
#ifndef OV_MSCKF_VIOMANAGERSLG_H
#define OV_MSCKF_VIOMANAGERSLG_H
...
#include "VioManagerOptionsSLG.h"
...
public:
   ...
   */
  VioManagerSLG(VioManagerOptionsSLG &params_, ov_lightglue::TrackSuperLightGlueConfig& slg_config_);
  ...
  VioManagerOptionsSLG get_params() { return params; }
