...
void VioManagerSLG::initialize_with_gt(Eigen::Matrix<double, 17, 1> imustate) {
...
bool VioManagerSLG::try_to_initialize(const ov_core::CameraData &message) {
...
void VioManagerSLG::retriangulate_active_tracks(const ov_core::CameraData &message) {
...
cv::Mat VioManagerSLG::get_historical_viz_image() {
...
std::vector<Eigen::Vector3d> VioManagerSLG::get_features_SLAM() {
...
std::vector<Eigen::Vector3d> VioManagerSLG::get_features_ARUCO() {
