...
public:
   ...
   */
  ROS1VisualizerSLG(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<VioManagerSLG> app, std::shared_ptr<Simulator> sim = nullptr);
...
protected:
  ...
  std::shared_ptr<VioManagerSLG> _app;
