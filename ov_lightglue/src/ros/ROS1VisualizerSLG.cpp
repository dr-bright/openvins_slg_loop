...
ROS1VisualizerSLG::ROS1VisualizerSLG(std::shared_ptr<ros::NodeHandle> nh, std::shared_ptr<VioManagerSLG> app, std::shared_ptr<Simulator> sim)
...
void ROS1VisualizerSLG::setup_subscribers(std::shared_ptr<ov_core::YamlParser> parser) {
  ...
  sub_imu = _nh->subscribe(topic_imu, 1000, &ROS1VisualizerSLG::callback_inertial, this);
  ...
  if (_app->get_params().state_options.num_cameras == 2) {
    ...
    sync->registerCallback(boost::bind(&ROS1VisualizerSLG::callback_stereo, this, _1, _2, 0, 1));
    ...
    for (int i = 0; i < _app->get_params().state_options.num_cameras; i++) {
      ...
      // create subscriber
      subs_cam.push_back(_nh->subscribe<sensor_msgs::Image>(cam_topic, 10, boost::bind(&ROS1VisualizerSLG::callback_monocular, this, _1, i)));
      PRINT_INFO("subscribing to cam (mono): %s\n", cam_topic.c_str());
    }
  }
}

void ROS1VisualizerSLG::visualize() {
...
void ROS1VisualizerSLG::visualize_odometry(double timestamp) {
...
void ROS1VisualizerSLG::visualize_final() {
...
void ROS1VisualizerSLG::callback_inertial(const sensor_msgs::Imu::ConstPtr &msg) {
...
void ROS1VisualizerSLG::callback_monocular(const sensor_msgs::ImageConstPtr &msg0, int cam_id0) {
...
void ROS1VisualizerSLG::callback_stereo(const sensor_msgs::ImageConstPtr &msg0, const sensor_msgs::ImageConstPtr &msg1, int cam_id0,
                                     int cam_id1) {
...
void ROS1VisualizerSLG::publish_state() {
...
void ROS1VisualizerSLG::publish_images() {
...
void ROS1VisualizerSLG::publish_features() {
...
void ROS1VisualizerSLG::publish_groundtruth() {
...
void ROS1VisualizerSLG::publish_loopclosure_information() {
