...
prepare_artifacts "slg_backend_smoke_test"
resolve_models
check_binary "slg_backend_smoke_test"
...
run_and_log "${TEST_ARTIFACT_DIR}/slg_backend_smoke_test.log" \
  "${BIN_DIR}/slg_backend_smoke_test" \
